...
namespace Topical_Memory_System
{
	public class Database
	{
		...
		public static VersePack LoadCustomVersesByGroupName(string incomingGroupName)
		{
		...
		public static void SaveVerseToDatabase(string incomingBook, int incomingChapter, string incomingVerseNumbers, 
		...
		public static int GetCustomGroupIdByName(string incomingGroupName)
		{
			int result = -1;
			SQLiteConnection conn;
			SQLiteCommand cmd;
		...
		public static void UpdateGroupName(string incomingOldName, string incomingNewName)
		{
			SQLiteConnection conn;
			SQLiteCommand cmd;
		...
		public static void DeleteVerse(Verse v)
		{
			SQLiteConnection conn;
			SQLiteCommand cmd;
